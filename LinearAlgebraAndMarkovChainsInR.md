...
Matrix is the base package.

expm (Goulet, Dutang,Maechler, Firth, Shapira, Stadelmann, and expm-developers@lists.R-forge.R-project.org 2013)
to perform efficient matrices powers; 

igraph (Csardi and Nepusz 2006) to perform pretty plotting

matlab (Roebuck 2011), that contains functions for matrix
management and calculations that emulate those within MATLAB environmen

Look into the operator syntax %^% for example

### iGraph Arpack example
...
###iGraph Example - note this is the package for Arpack interface as well
```
